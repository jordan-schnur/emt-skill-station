...
test.describe("EMS Mnemonics & Acronyms", () => {
  test("Reference nav button is visible in topbar", async ({ page }) => {
    await page.goto(".");
    const btn = page.locator(".topnav button", { hasText: "Reference" });
    await expect(btn).toBeVisible();
  });

  test("clicking Reference nav and then Mnemonics tab navigates to reference/mnemonics", async ({ page }) => {
    await page.goto(".");
  ...
  test("mnemonics view shows category filter chips", async ({ page }) => {
    ...
    await expect(page.locator(".ems-mnemonics")).toBeVisible();
    const allChip = page.locator(".ref-filter-chip", { hasText: "All" });
    await expect(allChip).toBeVisible();
    const chips = page.locator(".ref-filter-chip");
  ...
  test("category filter shows only matching cards", async ({ page }) => {
    await page.goto("./reference/mnemonics");
    const strokeChip = page.locator(".ref-filter-chip", { hasText: "Stroke" });
  ...
  test("Communication filter shows DMIST", async ({ page }) => {
    await page.goto("./reference/mnemonics");
    await page.locator(".ref-filter-chip", { hasText: "Communication" }).click();
  ...
  test("Pediatric / MCI filter shows START", async ({ page }) => {
    await page.goto("./reference/mnemonics");
    await page.locator(".ref-filter-chip", { hasText: "Pediatric / MCI" }).click();
    const acronyms = await page.locator(".ems-acronym").allTextContents();
  ...
  // Single-card quiz (practice specific card) via /reference/mnemonics/quiz/<id>
  test("practice icon in card header navigates to single-card quiz URL", async ({ page }) => {
    ...
    await icon.click();
    await expect(page).toHaveURL(/\/reference\/mnemonics\/quiz\/.+/);
  });
  ...
  test("single-card quiz shows only 1 card remaining", async ({ page }) => {
    await page.goto("./reference/mnemonics/quiz/sample");
    await expect(page.locator(".ems-quiz-card")).toBeVisible();
  ...
  test("Done screen back button returns to browse", async ({ page }) => {
    await page.goto("./reference/mnemonics/quiz/cms");
    await page.locator("button", { hasText: "Begin Quiz" }).click();
